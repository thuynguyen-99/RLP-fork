...
from rlp.repeat_dataset import RepeatPatchDataset
...
train_dataset = DatasetTrain(
    ...
    input_folder=opt.train_input_folder,
    gt_folder=opt.train_gt_folder,
    img_options=img_options_train,
)
train_dataset = RepeatPatchDataset(train_dataset, repeat=2)
...
for epoch in range(start_epoch, opt.nepoch + 1):
    ...
    if opt.save_images:
        ...
        for batch in range(len(restored)):
            ...
            restored_img.save(
                os.path.join(result_dir, "epoch{}_{}.png".format(epoch, input_name))
            )
